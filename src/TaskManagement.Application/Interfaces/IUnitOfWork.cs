...
/// <li>Mantiene consistencia en múltiples agregados del dominio</li>
/// <li>Abstrae gestión de transacción de base de datos del código de aplicación</li>
/// </ul>
///
/// Uso Típico:
/// <ul>
/// <li>Después de modificar entidades del dominio a través de repositorios</li>
/// <li>Antes de ejecutar eventos del dominio que dependen de persistencia exitosa</li>
/// <li>Los servicios de aplicación llaman a SaveChangesAsync después de coordinar operaciones del dominio</li>
/// </ul>
///
/// En esta implementación:
/// <ul>
/// <li><c>TaskDbContext</c> implementa tanto <c>DbContext</c> como IUnitOfWork</li>
/// <li>IUnitOfWork.SaveChangesAsync envuelve Entity Framework.</li>
/// </ul>
/// </remarks>
