...
/// valor</a> del dominio que representa posibles estados de una tarea.
/// </summary>
/// <remarks>
...
/// <li>Utilizado por entidad TaskItem para aplicar transiciones de estado válidas</li>
/// </ul>
///
/// Estados Válidos:
/// <ul>
